										...
										<ul>
											...
											<li class="active">
												<a href="profile-settings.html">
                                                    ...
                                                    <span><NavLink to = "/profile">Profile Settings</NavLink></span>
												</a>
											</li>
							...
							
								{
									...
									<div class="profile-info-widget">
										<a href="patient-profile.html" class="booking-doc-img">
											<img src="assets/img/patients/patient1.jpg" alt="User Image"></img>
										</a>
										<div class="profile-det-info">
											<h3><a href="patient-profile.html">{app.name}</a></h3>
											<div class="patient-details">
												<h5><i class="far fa-clock"></i>{app.date}</h5>
												<h5><i class="fa fa-user-md"></i>{app.doctor}</h5>
												<h5><i class="fas fa-envelope"></i>{app.purpose}</h5>
												<h5 class="mb-0"><i class="fas fa-phone"></i>{app.phone}</h5>
											</div>
										</div>
									</div>

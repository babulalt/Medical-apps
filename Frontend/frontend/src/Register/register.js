...
class Register extends Component {
    ...
    btnRegister = (e) => {
        ...
        axios.post("http://localhost:90/doctor/register", data)
            .then((dataa) => {
                            ...
                            <form class="login100-form validate-form" id="form1">
                              <span class="login100-form-title" id="text2">
                                ...
                                <div class="wrap-input100 validate-input" >
                                    <select class="input100" required="required" value={this.state.usertype} onChange={this.selectHandler}>
                                ...
                                <div class="text-center p-t-12">
                                    ...
                                    <li><NavLink to="/login">Already have an account? <b>login</b></NavLink></li>
                                </div>
